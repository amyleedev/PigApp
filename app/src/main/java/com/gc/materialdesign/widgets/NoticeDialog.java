...
public class NoticeDialog extends android.app.Dialog{
...
//		this.title = title;
	...
	public void addAccepteButton(String buttonAcceptText){
...
//	    setMessage(message);
	    ...
	    buttonAccept.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {//下一条
//				dismiss();
...
//					dismiss();
		...
		this.buttonClose = (ButtonFlat) findViewById(R.id.button_close);
	...
	public void setButtonCancel(ButtonFlat buttonClose) {
		this.buttonCancel = buttonCancel;
	}
	public ButtonFlat getButtonClose() {
		return buttonClose;
	}

	public void setButtonClose(ButtonFlat buttonClose) {
	...
	public void setOnCloseButtonClickListener(
			View.OnClickListener onCancelButtonClickListener) {
		this.onCloseButtonClickListener = onCancelButtonClickListener;
		if(buttonClose != null)
			buttonClose.setOnClickListener(onCancelButtonClickListener);
	}
	@Override
	public void dismiss() {
