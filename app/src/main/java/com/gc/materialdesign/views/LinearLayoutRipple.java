...
public class LinearLayoutRipple extends LinearLayout {
    ...
    public LinearLayoutRipple(Context context) {
        this(context, null);
    }
    ...
    public LinearLayoutRipple(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (event.getActionMasked() == MotionEvent.ACTION_DOWN
            ...
            mRadiusAnimator.addListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationEnd(Animator animator) {
                    setRadius(0);
                    ViewHelper.setAlpha(LinearLayoutRipple.this, 1);
                    mIsAnimating = false;
                }
