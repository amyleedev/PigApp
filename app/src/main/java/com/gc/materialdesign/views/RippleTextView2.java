...
public class RippleTextView2 extends TextView {
    ...
    public RippleTextView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public RippleTextView2(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        mRadius = getMax(radiusLeftTop, radiusRightTop, radiusLeftBottom, radiusRightBottom);
    ...
    public boolean performClick() {
        ...
        postDelayed(new Runnable() {
            @Override
            public void run() {
                RippleTextView2.super.performClick();
            }
        }, 150);
        return true;
