        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case DOWN_OK:
                    ...
                    pendingIntent = PendingIntent.getActivity(UpdateServcie.this, 0, intent, 0);

                    notification.flags = Notification.FLAG_AUTO_CANCEL;
                    notification.setLatestEventInfo(UpdateServcie.this,app_name, getString(R.string.down_sucess), pendingIntent);
                ...
                case DOWN_ERROR:
                    notification.flags = Notification.FLAG_AUTO_CANCEL;
//                    notification.setLatestEventInfo(this,app_name, getString(R.string.down_fail), pendingIntent);
                    notification.setLatestEventInfo(UpdateServcie.this,app_name, getString(R.string.down_fail), null);
    ...
    private void installApk() {
        ...
        intent.setDataAndType(uri,"application/vnd.android.package-archive");
        UpdateServcie.this.startActivity(intent);
    }
