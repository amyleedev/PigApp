...
public class VehicleListActivity extends BaseActivity {
	...
	private SwipeRefreshLayout.OnRefreshListener mRefreshListener = new SwipeRefreshLayout.OnRefreshListener() {
	 ...
	 @Override
	    public void onCreate(Bundle savedInstanceState) {
	        ...
	        setContentView(R.layout.vehiclelist_activity);
	        mToplayout = (RelativeLayout) findViewById(R.id.toplayout);
	        mToplayout.setVisibility(View.VISIBLE);
	        ((TextView)findViewById(R.id.def_head_tv)).setText("物流信息");
	...
	public void initView() {
		...
		infoAdapter = new VehiclesAdapter(VehicleListActivity.this, childJson);
		
		mContext=VehicleListActivity.this;
		...
		mSrlData = (MySwipeRefreshLayout) findViewById(R.id.srl_fragment);
		...
		mLv = (ListView) findViewById(R.id.lstv_fragment);
		...
		seachareabtn = (Button) findViewById(R.id.seachareabtn);
		...
		seachtimebtn = (Button) findViewById(R.id.seachtimebtn);
		seachtimebtn.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				new TimePopupWindows(VehicleListActivity.this, v);

			}
		});
		seachtypebtn = (Button) findViewById(R.id.seachtypebtn);
		seachtypebtn.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				new TypePopupWindows(VehicleListActivity.this, v);
				
			}
		});
		seachpricebtn = (Button) findViewById(R.id.seachpricebtn);
		seachpricebtn.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				
				startActivityForResult(new Intent(VehicleListActivity.this,ChosePriceActivity.class), 23);
			}
		});
	...
	private void loadData() {
		...
		params.addBodyParameter("e.companyId", companyId);
		...
		http.send(HttpRequest.HttpMethod.POST, UrlEntry.QUERY_VEHIVLE_ALL_URL,
				params, new RequestCallBack<String>() {
					...
					public void onSuccess(ResponseInfo<String> responseInfo) {
						...
						Log.i("物流车辆", " 物流 responseInfo.result = "
								+ responseInfo.result);
	...
	public class TimePopupWindows extends PopupWindow {
		...
		public TimePopupWindows(Context mContext, View parent) {
			...
			gettimedata();
			SimpleAdapter adapter = new SimpleAdapter(VehicleListActivity.this, data,
	...
	public class TypePopupWindows extends PopupWindow {
		...
		public TypePopupWindows(Context mContext, View parent) {
			...
			SimpleAdapter adapter = new SimpleAdapter(VehicleListActivity.this, typedata,
