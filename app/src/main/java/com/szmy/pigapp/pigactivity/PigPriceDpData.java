...
public class PigPriceDpData extends RelativeLayout {
	...
	public PigPriceDpData(Context context) {
		this(context, null, 0);
	
		
	}

	public PigPriceDpData(Context context, AttributeSet attrs) {
...
private void initView(){
	...
	public void loadData() {
		...
		params.addBodyParameter("e.productType", "豆粕");
