...
public class PigPriceTzzData extends RelativeLayout {
	...
	public PigPriceTzzData(Context context) {
		this(context, null, 0);
		
		
	}

	public PigPriceTzzData(Context context, AttributeSet attrs) {
...
private void initView(){
	...
	public void loadData() {
		...
		params.addBodyParameter("e.productType", "土杂猪");
