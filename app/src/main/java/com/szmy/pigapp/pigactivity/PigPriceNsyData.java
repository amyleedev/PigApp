...
public class PigPriceNsyData extends RelativeLayout {
	...
	public PigPriceNsyData(Context context) {
		this(context, null, 0);
		
		
	}

	public PigPriceNsyData(Context context, AttributeSet attrs) {
...
private void initView(){
	...
	public void loadData() {
		...
		params.addBodyParameter("e.productType", "内三元");
