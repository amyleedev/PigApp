...
public class PigPriceWsyData extends RelativeLayout {
    ...
    public PigPriceWsyData(Context context) {
        this(context, null, 0);
    }
	public PigPriceWsyData(){
		super(null);
	}

    public PigPriceWsyData(Context context, AttributeSet attrs) {
    ...
    public void loadData() {
        ...
        params.addBodyParameter("e.productType", "外三元");
        params.addBodyParameter("e.type", "生猪");
