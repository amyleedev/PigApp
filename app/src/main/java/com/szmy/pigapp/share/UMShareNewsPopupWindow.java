...
public class UMShareNewsPopupWindow {
	private FragmentActivity context;
	public UMSocialService mController;
	private String text = "来自猪贸通的分享：";
	public String imageurl = UrlEntry.ip + "/appDownload/icon.png";
	...
	public UMShareNewsPopupWindow(FragmentActivity context,String url,String content) {
...
//			getImg(context.getResources(), url);
...
//	}
	 ...
	 * @param platform
	 */
	private void sflogin(final Context mCon,final SHARE_MEDIA platform) {
	 ...
	 * @param platform
	 */
	private void getUserInfo(final Context mCon , SHARE_MEDIA platform) {
