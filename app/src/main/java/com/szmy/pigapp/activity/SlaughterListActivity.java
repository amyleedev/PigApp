...
import com.szmy.pigapp.adapter.SlaughterHouseAdapter;
...
public class SlaughterListActivity extends BaseActivity  {

	private LayoutInflater mInflater;
	private List<SlaughterhouseEntry> childJson = new ArrayList<SlaughterhouseEntry>(); // 子列表
	private SlaughterHouseAdapter infoAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mTvMap.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				Intent intent = new Intent(SlaughterListActivity.this,
	...
	public void initView() {
		...
		infoAdapter = new SlaughterHouseAdapter(SlaughterListActivity.this,childJson);
		mContext=SlaughterListActivity.this;
