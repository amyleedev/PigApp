...
public class NewsListActivity extends BaseActivity {
	...
	public void initView() {
		...
		infoAdapter = new NewsAdapter(NewsListActivity.this, childJson);
	...
	private void loadData() {
		...
		if (!TextUtils.isEmpty(mType)) {
			...
			params.addBodyParameter("e.zmtType", mType);
		}
		...
		try {
			...
			if (jsonresult.get("success").toString().equals("1")) {
				...
				if (mPage == 1) {
					...
					infoAdapter = new NewsAdapter(NewsListActivity.this,
							childJson);
