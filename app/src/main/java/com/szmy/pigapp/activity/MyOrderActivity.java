...
public class MyOrderActivity extends BaseActivity implements OnCheckedChangeListener {

	private LayoutInflater mInflater;
	private List<InfoEntry> childJson = new ArrayList<InfoEntry>(); // 子列表
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		((TextView) findViewById(R.id.def_head_tv)).setText("我的订单");
...
//		mAllBtn = (RadioButton) findViewById(R.id.allorderbtn); // 所有
...
//				
//				orderStatus = "";
//				loadData("1", "20", "", "", "", "", "", "",TYPE_REFRESH);
//			}
//		});
//		mObligationBtn = (RadioButton) findViewById(R.id.obligationbtn); // 待付款
//		mObligationBtn.setOnCheckedChangeListener(new OnCheckedChangeListener() {
//			
//			@Override
...
//			}
//		});
//		mWaitSippingBtn = (RadioButton) findViewById(R.id.daifahuobtn);//待发货
//		mWaitSippingBtn.setOnCheckedChangeListener(new OnCheckedChangeListener() {
//			
//			@Override
//			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
//				orderStatus = "5";
...
//			}
//		});
//		mWaitReceiptBtn = (RadioButton) findViewById(R.id.daishouhuobtn); // 待收货
//		mWaitReceiptBtn.setOnCheckedChangeListener(new OnCheckedChangeListener() {
//			
//			@Override
//			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
//				orderStatus = "6";
