...
public class PigFarmListActivity extends BaseActivity {
	...
	private String URL;
	String provinceContent, cityContent,areaContent;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mTvMap.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				Intent intent = new Intent(PigFarmListActivity.this,
	...
	private void initView() {
		...
		infoAdapter = new FarmAdapter(PigFarmListActivity.this, childJson);

		mContext = PigFarmListActivity.this;
		...
		try {
			...
			if (jsonresult.get("success").toString().equals("1")) {
				...
				if (mPage == 1) {
					...
					infoAdapter = new FarmAdapter(PigFarmListActivity.this,
							childJson);
