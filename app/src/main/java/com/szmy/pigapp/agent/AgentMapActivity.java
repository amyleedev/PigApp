...
public class AgentMapActivity extends BaseActivity {
	...
	protected void onCreate(Bundle arg0) {
		...
		((TextView) findViewById(R.id.def_head_tv)).setText("经纪人地图");
		...
		mBaiduMap.setOnMarkerClickListener(new OnMarkerClickListener() {
			...
			public boolean onMarkerClick(final Marker marker) {
				...
				if (myZoom == MyMapZoom.BIG) {
					// 获得marker中的数据
					flag = 3;
					entity = (AgentEntry) marker.getExtraInfo().get("info");
	...
	private void info() {
		...
		Intent intent = new Intent(AgentMapActivity.this,
				AgentMoreActivity.class);
		intent.putExtra("name", entity.getRealName());
		intent.putExtra("business", entity.getBusiness());
		intent.putExtra("companyName", entity
				.getCompanyName());
		intent.putExtra("qq", entity.getQQ());
		...
		intent.putExtra("intro", entity.getIntro());
	...
	public void loadData() {
		...
		http.send(HttpRequest.HttpMethod.POST,
				UrlEntry.QUERY_AGENT_AREA_URL, params,
	...
	private void addOverly(AgentEntry info) {
