...
public class ImageZoomActivity extends Activity {
	...
	private void initData() {
		currentPosition = getIntent().getIntExtra(
				CustomConstants.EXTRA_CURRENT_IMG_POSITION, 0);
		if(getIntent().getStringExtra("name").equals("newinfo")){
			mDataList = NewInfoActivity.mDataList;	
		}else{
			mDataList = NewVehicleActivity.mDataList;
		}		 
	}
