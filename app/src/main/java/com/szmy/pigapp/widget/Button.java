...
public abstract class Button extends CustomView {
	...
	protected void setDefaultProperties() {
		// Min size
		setMinimumHeight(FileUtil.dpToPx(minHeight, getResources()));
		setMinimumWidth(FileUtil.dpToPx(minWidth, getResources()));
		// Background shape
	...
	public Bitmap makeCircle() {
		Bitmap output = Bitmap.createBitmap(
				getWidth() - FileUtil.dpToPx(6, getResources()), getHeight()
						- FileUtil.dpToPx(7, getResources()), Config.ARGB_8888);
