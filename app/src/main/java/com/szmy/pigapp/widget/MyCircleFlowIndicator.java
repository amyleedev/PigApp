 ...
 */
public class MyCircleFlowIndicator extends View implements MyFlowIndicator,
		AnimationListener {
	 ...
	 * @param context
	 */
	public MyCircleFlowIndicator(Context context) {
		super(context);
	 ...
	 * @param attrs
	 */
	public MyCircleFlowIndicator(Context context, AttributeSet attrs) {
		super(context, attrs);
	 ...
	 */
	@Override
	public void setViewFlow(MyViewFlow view) {
		resetTimer();
		viewFlow = view;
