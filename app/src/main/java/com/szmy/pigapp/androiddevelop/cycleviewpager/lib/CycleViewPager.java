package com.szmy.pigapp.androiddevelop.cycleviewpager.lib;
...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
	 ...
	 *            默认显示位置
	 */
	public void setData(List<ImageView> views, List<Banner> list, ImageCycleViewListener listener, int showPosition) {
				...
				v.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						if(indicators.length==1){
							...
							mImageCycleViewListener.onImageClick(infos.get(0),0, v);
						}else{
	...
	public static interface ImageCycleViewListener {
		 ...
		 * @param imageView
		 */
		public void onImageClick(Banner info, int postion, View imageView);
	}
}